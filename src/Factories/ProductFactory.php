...
$factory->state(Product::class, 'creation', fn (Faker $faker, array $attributes) => [
    ...
    'buying_currency' => $attributes['buying_currency'] ?? '',
    'inventory_tracking' => $attributes['inventory_tracking'] ?? $faker->boolean,
    'initial_stock_count' => $attributes['initial_stock_count'] ?? '',
]);

$factory->state(Product::class, 'response', fn (Faker $faker, array $attributes) => [
    'sales_excise_duty_code' => $attributes['sales_excise_duty_code'] ?? '',
    'sales_invoice_details_count' => $attributes['sales_invoice_details_count'] ?? '',
    'purchase_invoice_details_count' => $attributes['purchase_invoice_details_count'] ?? '',
    'list_price_in_trl' => $attributes['list_price_in_trl'] ?? '',
    'buying_price_in_trl' => $attributes['buying_price_in_trl'] ?? '',
